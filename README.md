...
|---------|-------------|------|
| [Something's Phishy](https://github.com/asq2000/portfolio-phishguard--Cybersecurity-Project) | Cybersecurity awareness platform to identify phishing attacks | HTML/CSS/JS, AI |
| [Gather Savor](https://github.com/asq2000/Gather-savor_Final-Project) | Full-stack meal planning app with recipe browsing & shopping lists | PHP, MySQL, JS |
...
- **Tools:** Git, Arduino, Figma, CISCO Packet Tracer
- **Concepts:** Cybersecurity, Machine Learning, Database Design, Networking

---

## 📬 Contact
- Email: angeleesq3@gmail.com
- GitHub: [github.com/asq2000](https://github.com/asq2000)
